...
/**
 * Apple-Maps-canvas center control: a perfectly round white tactile button
 * over a jet-black background, with a 50%-screen-width waveform line below
 * it that reflects the current recording pipeline state — shared by both a
 * manual tap and Active Mode's hands-free loop (see app/index.tsx), so the
 * two never show a different visual state for the same underlying pipeline.
 */
